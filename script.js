    ...
    const sizePresets = [
      { rootMin: 44, rootVw: '6.5vw', rootMax: 80, box: 42, boxFont: 20, boxMobile: 34, boxMobileFont: 16 },
      { rootMin: 48, rootVw: '7vw', rootMax: 88, box: 46, boxFont: 22, boxMobile: 38, boxMobileFont: 18 },
      { rootMin: 52, rootVw: '8vw', rootMax: 96, box: 50, boxFont: 24, boxMobile: 42, boxMobileFont: 20 }
    ];
    let sizeIndex = 1;
